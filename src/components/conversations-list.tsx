        ...
        <div>
            {conversations.length > 0 ? (
                <div className="space-y-1">
                    <Link href={`/messages/ai`} className="block hover:bg-muted/50 rounded-lg">
                         <div className="flex items-center p-2 gap-3 relative">
                             <Avatar className="h-12 w-12 bg-primary text-primary-foreground">
                                <Bot />
                            </Avatar>
                             <div className="flex-1 truncate">
                                <p className="font-semibold truncate">Unite AI Assistant</p>
                                <p className="text-sm text-muted-foreground truncate">Ask me anything about the platform!</p>
                             </div>
                        </div>
                    </Link>
